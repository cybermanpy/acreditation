...
urlpatterns = [
    ...
    url(r'^dashboard/evaluator/add/declaration/(?P<user>[0-9]+)$', views.newDeclaration, name='newDeclaration'),
    ...
    url(r'^dashboard/evaluator/declaration/$', views.searchDeclaration, name='searchDeclaration'),
