...
urlpatterns = [
    ...
    url(r'^dashboard/evaluator/list/declaration/$', views.viewDeclaration, name='viewDeclaration'),
    url(r'^dashboard/evaluator/add/declaration/$', views.newDeclaration, name='newDeclaration'),
    url(r'^dashboard/evaluator/edit/declaration/(?P<pk>[0-9]+)/$', views.editDeclaration, name='editDeclaration'),
