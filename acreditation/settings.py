"""
Django settings for acreditation project.
...
SECRET_KEY = '3nj(cs6hmej791vzd^c^9(j!7%k7kjd89f+@3irn)=*ug$$gtb'
...
ROOT_URLCONF = 'acreditation.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                'acreditation.context_processors.getUsername',
...
WSGI_APPLICATION = 'acreditation.wsgi.application'
